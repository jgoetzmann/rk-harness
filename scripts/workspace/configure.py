...
SCHEMA: dict[str, tuple] = {
    ...
    "run.sidetrack_max_seconds":  (180, int, (30, 600), "container",
                                   "budget for one side-track firing; it gates starting a point, so a firing can overrun by the length of the point already running. Keep cycle + budget under stop.ps1's 20-minute graceful-stop wait"),
    "run.sidetrack_tracks":       ("both", str, ("both", "adaptive", "implicit", "off"), "container",
                                   "which side tracks are eligible; off silences them without losing the cadence setting"),
    "run.lane_schedule":          ("E", str, None, "container",
