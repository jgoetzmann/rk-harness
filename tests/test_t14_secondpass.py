...
_LADDER_GOLDEN: dict[str, str] = {
    "rk4 dahlquist n_max=256": (
        '{"problem":"dahlquist","n_max":256,"bisect_probes":12,"cycles_per_step":53,"'
        'ladder_monotone":true,"ladder":[{"n":1,"status":"overflow","error":null,"max'
        '_abs_q":null},{"n":2,"status":"overflow","error":null,"max_abs_q":null},{"n"'
        ':4,"status":"overflow","error":null,"max_abs_q":null},{"n":8,"status":"overf'
        'low","error":null,"max_abs_q":null},{"n":16,"status":"ok","error":0.00016747'
        '024226248486,"max_abs_q":8192},{"n":32,"status":"ok","error":0.0001674702422'
        '6248486,"max_abs_q":8192},{"n":64,"status":"ok","error":4.5399929762484854e-'
        '05,"max_abs_q":8192},{"n":128,"status":"ok","error":4.5399929762484854e-05,"'
        'max_abs_q":8192},{"n":256,"status":"ok","error":4.5399929762484854e-05,"max_'
        'abs_q":8192}],"targets":{"0.015625":{"target":0.015625,"n":11,"cycles":583,"'
        'status":"reached","probes":3,"probed":[{"n":10,"status":"overflow","error":n'
        'ull},{"n":11,"status":"ok","error":4.5399929762484854e-05},{"n":12,"status":'
        '"ok","error":0.00016747024226248486}],"ladder_monotone":true},"0.00390625":{'
        '"target":0.00390625,"n":11,"cycles":583,"status":"reached","probes":3,"probe'
        'd":[{"n":10,"status":"overflow","error":null},{"n":11,"status":"ok","error":'
        '4.5399929762484854e-05},{"n":12,"status":"ok","error":0.00016747024226248486'
        '}],"ladder_monotone":true},"0.0009765625":{"target":0.0009765625,"n":11,"cyc'
        'les":583,"status":"reached","probes":3,"probed":[{"n":10,"status":"overflow"'
        ',"error":null},{"n":11,"status":"ok","error":4.5399929762484854e-05},{"n":12'
        ',"status":"ok","error":0.00016747024226248486}],"ladder_monotone":true},"0.0'
        '00244140625":{"target":0.000244140625,"n":11,"cycles":583,"status":"reached"'
        ',"probes":3,"probed":[{"n":10,"status":"overflow","error":null},{"n":11,"sta'
        'tus":"ok","error":4.5399929762484854e-05},{"n":12,"status":"ok","error":0.00'
        '016747024226248486}],"ladder_monotone":true}}}'
    ),
    "euler rc_thermal n_max=128": (
        '{"problem":"rc_thermal","n_max":128,"bisect_probes":12,"cycles_per_step":15,'
        '"ladder_monotone":false,"ladder":[{"n":1,"status":"overflow","error":null,"m'
        'ax_abs_q":null},{"n":2,"status":"overflow","error":null,"max_abs_q":null},{"'
        'n":4,"status":"overflow","error":null,"max_abs_q":null},{"n":8,"status":"ove'
        'rflow","error":null,"max_abs_q":null},{"n":16,"status":"overflow","error":nu'
        'll,"max_abs_q":null},{"n":32,"status":"overflow","error":null,"max_abs_q":nu'
        'll},{"n":64,"status":"ok","error":0.002746482895528819,"max_abs_q":8192},{"n'
        '":128,"status":"ok","error":0.005489900090930159,"max_abs_q":8192}],"targets'
        '":{"0.015625":{"target":0.015625,"n":34,"cycles":510,"status":"reached","pro'
        'bes":5,"probed":[{"n":33,"status":"ok","error":0.11644306571586242},{"n":34,'
        '"status":"ok","error":0.012586638539218004},{"n":36,"status":"ok","error":0.'
        '004385919215434468},{"n":40,"status":"ok","error":0.0039559633713092185},{"n'
        '":48,"status":"ok","error":0.003655416218107611}],"ladder_monotone":false},"'
        '0.00390625":{"target":0.00390625,"n":48,"cycles":720,"status":"reached","pro'
        'bes":5,"probed":[{"n":40,"status":"ok","error":0.0039559633713092185},{"n":4'
        '4,"status":"ok","error":0.004298752049493257},{"n":46,"status":"ok","error":'
        '0.004509614130315321},{"n":47,"status":"ok","error":0.004587252284839524},{"'
        'n":48,"status":"ok","error":0.003655416218107611}],"ladder_monotone":false},'
        '"0.0009765625":{"target":0.0009765625,"n":null,"cycles":null,"status":"never'
        '_reached","probes":0,"probed":[],"ladder_monotone":false},"0.000244140625":{'
        '"target":0.000244140625,"n":null,"cycles":null,"status":"never_reached","pro'
        'bes":0,"probed":[],"ladder_monotone":false},"1e-09":{"target":1e-09,"n":null'
        ',"cycles":null,"status":"never_reached","probes":0,"probed":[],"ladder_monot'
        'one":false}}}'
    ),
    "blowup rc_thermal n_max=64": (
        '{"problem":"rc_thermal","n_max":64,"bisect_probes":4,"cycles_per_step":45,"l'
        'adder_monotone":true,"ladder":[{"n":1,"status":"overflow","error":null,"max_'
        'abs_q":null},{"n":2,"status":"overflow","error":null,"max_abs_q":null},{"n":'
        '4,"status":"overflow","error":null,"max_abs_q":null},{"n":8,"status":"overfl'
        'ow","error":null,"max_abs_q":null},{"n":16,"status":"overflow","error":null,'
        '"max_abs_q":null},{"n":32,"status":"overflow","error":null,"max_abs_q":null}'
        ',{"n":64,"status":"overflow","error":null,"max_abs_q":null}],"targets":{"0.0'
        '15625":{"target":0.015625,"n":null,"cycles":null,"status":"overflow_before_t'
        'arget","probes":0,"probed":[],"ladder_monotone":true}}}'
    ),
}
